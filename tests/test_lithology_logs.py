...
class TestLithologyLogs:
    ...
    def sample_geology(self):
        ...
        return pd.DataFrame({
            DhConfig.holeid: ['DH001', 'DH001', 'DH001', 'DH002', 'DH002', 'DH002', 'DH003', 'DH003'],
            DhConfig.sample_from: [0.0, 30.0, 80.0, 0.0, 40.0, 90.0, 0.0, 50.0],
            DhConfig.sample_to: [30.0, 80.0, 120.0, 40.0, 90.0, 150.0, 50.0, 120.0],
            'LITHO': ['granite', 'schist', 'granite', 'sandstone', 'schist', 'granite', 'granite', 'schist']
        })
    ...
    def test_initialization_custom_column(self, database_with_geology):
        ...
        litho_logs = LithologyLogs(database_with_geology, 'geology_custom', lithology_column='ROCK_TYPE')
