...
class TestPreprocessing:
    ...
    def test_validate_numerical_columns_chainable(self, database, assay_with_mixed_data):
        ...
        # Should be chainable
        result = database.validate_numerical_columns('assay', ['CU_PPM']).validate_numerical_columns('assay', ['AU_PPM'])
    ...
    def test_validate_numerical_columns_interval_table(self, database):
        ...
        database.validate_numerical_columns('geology', ['GRADE'], table_type='interval', allow_negative=False)
    ...
    def test_validate_numerical_columns_missing_column_warning(self, database, assay_with_mixed_data):
    ...
    def test_filter_by_nan_threshold_basic(self, database):
        ...
        filtered_db = database.filter_by_nan_threshold('assay', ['CU_PPM', 'AU_PPM', 'AG_PPM'], threshold=0.66)
    ...
    def test_combined_preprocessing_workflow(self, database, assay_with_mixed_data):
        ...
        database.validate_numerical_columns('assay', ['CU_PPM', 'AU_PPM', 'AG_PPM'], allow_negative=False)
        
        # Step 2: Filter by NaN threshold (at least 67% valid means > 0.66)
        filtered_db = database.filter_by_nan_threshold('assay', ['CU_PPM', 'AU_PPM', 'AG_PPM'], threshold=0.67)
